...
assign car_rgb = 12'h000; //car color
assign canvas_on =  (car_x_l <=pixel_x) && (pixel_x<=car_x_r) && (car_y_t <= pixel_y);
...
always @*
  case(car_rom_addr)
    ...
    4'hb: car_rom_data = 8'b10111101; // b
    4'hc: car_rom_data = 8'b11111111; // c
    4'hd: car_rom_data = 8'b10111101; // d
    4'he: car_rom_data = 8'b00111100; // e
    4'hf: car_rom_data = 8'b00000000; // f
endcase
